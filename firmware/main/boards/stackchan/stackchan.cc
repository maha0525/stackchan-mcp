...
private:
    ...
    void TouchPollTick() {
        ...
        if (now) {
            ...
            touch_press_start_us_ = now_us;
            // Capture the sensor state at the moment the press is confirmed,
            // so the log emitted on the falling edge can show the actual
            // touch signature instead of the post-release zeroes.
